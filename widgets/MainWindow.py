...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalSpacer = QSpacerItem(0, 0, QSizePolicy.Preferred, QSizePolicy.Minimum)
        ...
        self.short_description_edit = QLineEdit(self.centralwidget)
        self.short_description_edit.setObjectName(u"short_description_edit")
        sizePolicy = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(240)
        sizePolicy.setHeightForWidth(self.short_description_edit.sizePolicy().hasHeightForWidth())
        self.short_description_edit.setSizePolicy(sizePolicy)
        self.short_description_edit.setMinimumSize(QSize(0, 80))
        self.short_description_edit.setInputMethodHints(Qt.ImhMultiLine)
        self.short_description_edit.setFrame(True)

        self.gridLayout.addWidget(self.short_description_edit, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.plainTextEdit, 11, 1, 1, 1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 535, 24))
        ...
        QWidget.setTabOrder(self.radioButton_3, self.short_description_edit)
        QWidget.setTabOrder(self.short_description_edit, self.plainTextEdit)
        QWidget.setTabOrder(self.plainTextEdit, self.po_textbox)
